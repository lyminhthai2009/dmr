...
public class ModComponents {
    ...
    // --- CÁC THÀNH PHẦN DI TRUYỀN VIP MỚI ---
    public static final Supplier<DataComponentType<CompoundTag>> GENETICS =
            register("genetics", CompoundTag.CODEC, ByteBufCodecs.COMPOUND_TAG);
    public static final Supplier<DataComponentType<UUID>> MOTHER =
            register("mother_uuid", UUIDUtil.CODEC, UUIDUtil.STREAM_CODEC);
    public static final Supplier<DataComponentType<UUID>> FATHER =
            register("father_uuid", UUIDUtil.CODEC, UUIDUtil.STREAM_CODEC);
